...
def solution(banks)
  ...
  loop do
    ...
    if states[current_state_key]
      break
    end

    states[current_state_key] = true
    result += 1
...
class SolutionTest < ::MiniTest::Test
  def test_example_input
    assert_equal 5, solution([0, 2, 7, 0])
  end

  def test_solution
    assert_equal 7864, solution([0, 5, 10, 0, 11, 14, 13, 4, 11, 8, 8, 7, 1, 4, 12, 11])
  end
end