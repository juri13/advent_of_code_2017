...
def solution(spreadsheet)
  ...
  spreadsheet.each do |row|
    ...
    row.each do |integer|
      ...
      stack.each do |candidate|
        if integer % candidate == 0
          finished = true
          result += integer / candidate
        elsif candidate % integer == 0
          finished = true
          result += candidate / integer
        end
      end
